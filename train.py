...
def train(nb_epoch, batch_size, exp_dir, resume=False, start_epoch=0, model_path=None, ald_lr=0.002, base_lr=0.002,
    ...
    if resume:
        ...
        net = load_model(model_name='vgg16_pmg', pretrain=True, require_grad=True,num_class=num_class)
    net = net.cuda()
    if use_mgpu :
    ...
    if use_mgpu:
        optimizer = optim.SGD([
            {'params': net.module.classifier_concat.parameters(), 'lr': base_lr},
            {'params': net.module.conv_block1.parameters(), 'lr': base_lr},
            {'params': net.module.classifier1.parameters(), 'lr': base_lr},
            {'params': net.module.conv_block2.parameters(), 'lr': base_lr},
            {'params': net.module.classifier2.parameters(), 'lr': base_lr},
            {'params': net.module.conv_block3.parameters(), 'lr': base_lr},
            {'params': net.module.classifier3.parameters(), 'lr': base_lr},
            {'params': net.module.features.parameters(), 'lr': base_lr * 0.1}
        ...
        optimizer = optim.SGD([
            {'params': net.classifier_concat.parameters(), 'lr': base_lr},
            {'params': net.conv_block1.parameters(), 'lr': base_lr},
            {'params': net.classifier1.parameters(), 'lr': base_lr},
            {'params': net.conv_block2.parameters(), 'lr': base_lr},
            {'params': net.classifier2.parameters(), 'lr': base_lr},
            {'params': net.conv_block3.parameters(), 'lr': base_lr},
            {'params': net.classifier3.parameters(), 'lr': base_lr},
            {'params': net.features.parameters(), 'lr': base_lr * 0.1}
    ...
    for epoch in range(start_epoch, nb_epoch):
        ...
        if epoch < 5 or epoch >= 80:
            val_acc, val_acc_com, val_loss = test(net, CELoss, 32,dset)
