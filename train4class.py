...
def train(nb_epoch, batch_size, exp_dir, resume=False, start_epoch=0, model_path=None, ald_lr=0.002 , base_lr=0.002,
    ...
    net = model4class(num_class,dset)
    net = net.cuda()
    if use_mgpu :
    ...
    for epoch in range(start_epoch, nb_epoch):
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            # Step 1
            optimizer.zero_grad()
            output_1, _, _, _, result_8 = net(inputs, '8', targets, tra)
            # print(3)
            ...
            # Step 4
            optimizer.zero_grad()
            _, _, _, output_concat = net(inputs, 'original', targets, tra)
        ...
        val_acc, val_acc_com, val_loss = test4class(net, CELoss, 32,dset)
