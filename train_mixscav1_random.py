...
def train(nb_epoch, batch_size, exp_dir, resume=False, start_epoch=0, model_path=None, ald_lr=0.002 , base_lr=0.002,
    ...
    net = model4mixscalev1_random( num_train,num_class)
    net = net.cuda()
    if use_mgpu :
    ...
    for epoch in range(start_epoch, nb_epoch):
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            # Step 1
            optimizer.zero_grad()
            output_1, _, _, _ = net(inputs, '8', batch_idx, batch_size, tra)
            # print(3)
            ...
            # Step 2
            optimizer.zero_grad()
            _, output_2, _, _ = net(inputs, '4', batch_idx, batch_size, tra)
            ...
            # Step 3
            optimizer.zero_grad()
            _, _, output_3, _ = net(inputs, '2', batch_idx, batch_size, tra)
        ...
        val_acc, val_acc_com, val_loss = test_mixscav1_random(net, CELoss, 32,dset)
