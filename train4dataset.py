...
def train(nb_epoch, batch_size, exp_dir, resume=False, start_epoch=0, model_path=None, ald_lr=0.002 , base_lr=0.002,
    ...
    net = model4dataset(num_dataset,dset=dset)
    net = net.cuda()
    if use_mgpu:
    ...
    for epoch in range(start_epoch, nb_epoch):
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            # Step 1
            optimizer.zero_grad()
            output_1, _, _, _, result_8 = net(inputs, 8, tra)
            # print(3)
            ...
            # Step 2
            optimizer.zero_grad()
            _, output_2, _, _, result_4 = net(inputs, 4,  tra)
            ...
            # Step 3
            optimizer.zero_grad()
            _, _, output_3, _, result_2 = net(inputs, 2,  tra)
            ...
            # Step 4
            optimizer.zero_grad()
            _, _, _, output_concat = net(inputs, 1,  tra)
        ...
        val_acc, val_acc_com, val_loss = test4dataset(net, CELoss, 32)
